...
public class EntrepriseServiceImplTest {
	...
	public void testRetrieveAllEntreprises() {
	  ...
	  @Test public void testgetEntrepriseById() { Entreprise entrepriseRetrieved =
	  es.getEntrepriseById(3); assertEquals(3, entrepriseRetrieved.getId()); }
	  
	  @Test public void testdeleteEntrepriseById() {
	  
	  Entreprise e =entrepriseRepoistory.findById(10).get();
	  
	  es.deleteEntrepriseById(10); assertEquals(10, e.getId()); }
	  
	  @Test public void testdeleteDepartementById() {
	  
	  Departement d=deptRepoistory.findById(2229).get();
	  
	  es.deleteDepartementById(2229);; assertEquals(2229, d.getId()); }
	 ...
	 // Departement d=deptRepoistory.findById(2227).get();
	  ...
	  es.affecterDepartementAEntreprise(2227, 7); assertEquals(1,
	  e.getDepartements().size()); }
